...
class KeyboardKey: UIControl {
    ...
    init(vibrancy optionalVibrancy: VibrancyType?, isBlank:Bool) {
        ...
        self.underColor = UIColor.lightGray
    ...
    func setupViews() {
        ...
        self.borderView?.fillColor = UIColor.white
...
//            self.connector!.drawUnder = false
    ...
    func showPopup() {
        self.layer.zPosition = 9999999
        UIView.animate(withDuration: 0.2, delay: 0.0, usingSpringWithDamping: 0.5, initialSpringVelocity: 0.5, options: UIViewAnimationOptions(), animations: {
...
//            popupLabel.font = UIFont.systemFontOfSize(22 * 2, weight: UIFontWeightThin)
